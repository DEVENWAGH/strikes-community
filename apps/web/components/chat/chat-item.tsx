...
import { Member, Profile } from "@repo/db";
        ...
        <div className="relative group flex items-center p-4 transition w-full hover:bg-black/5 dark:hover:bg-zinc-900/50">
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    {(isPDF || (isImage && hasError)) && (
                        <div className="relative flex items-center p-2 mt-2 rounded-md bg-zinc-100 dark:bg-zinc-800 border">
            ...
            {canDeleteMessage && (
                <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border rounded-sm shadow-sm transition">
                    {canEditMessage && (
